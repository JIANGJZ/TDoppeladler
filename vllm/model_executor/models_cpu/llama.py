...
from vllm.model_executor.layers_cpu.activation import SiluAndMul
from vllm.model_executor.layers_cpu.attention import PagedAttention
from vllm.model_executor.layers_cpu.layernorm import RMSNorm
from vllm.model_executor.layers_cpu.linear import (LinearMethodBase,MergedColumnParallelLinear,QKVParallelLinear,RowParallelLinear)                                             
from vllm.model_executor.layers_cpu.rotary_embedding import get_rope
from vllm.model_executor.layers_cpu.sampler import Sampler
from vllm.model_executor.layers_cpu.vocab_parallel_embedding import (VocabParallelEmbedding, ParallelLMHead)
...
class LlamaForCausalLM(nn.Module):
    ...
    def sample(self, hidden_states: torch.Tensor, sampling_metadata: SamplingMetadata, ) -> SamplerOutput:
